...
| `PERSISTENT_LOGS` | bool | `false` | Debug logging only; persists logs to internal LittleFS. Aliases: `SAVE_LOGS`, `LOG_TO_SD_CARD`. Use only briefly in scheduled mode outside therapy times. |
